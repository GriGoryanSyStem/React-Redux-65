    ...
    return (
        <div>
            <form onSubmit={props.handleSubmit}>
                ...
                <div>
                    <Field component={renderField} name ={'password'} type="password" label = 'password' placeholder="password" validate={[required, maxLength30, minLength5]}/></div>
                <div>
                    <Field component={renderField} name ={'rememberMe'} type="checkbox" /> Remember Me</div>
                <div>
